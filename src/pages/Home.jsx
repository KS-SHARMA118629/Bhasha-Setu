  ...
  return (
    <div className="container" style={{ textAlign: 'center', paddingTop: '4rem', paddingBottom: '4rem' }}>
      ...
      <div className="responsive-grid">
        {[
          { icon: <MessageSquare size={32} color="#ff4e20" />, title: 'Instant Translation', desc: 'Real-time text translation across 10+ Indian languages.' },
          { icon: <ShieldCheck size={32} color="#ffd700" />, title: 'Verified Profiles', desc: 'Secure and verified interactions for safe citizen helpdesk support.' },
          { icon: <Mic size={32} color="#ff1a1a" />, title: 'Voice Support', desc: 'Upcoming features include voice-to-text assistance.' },
          { icon: <FileText size={32} color="#ff8a00" />, title: 'Ticket System', desc: 'Raise, manage, and track your help requests easily.' }
        ].map((feature, idx) => (
          <div key={idx} className="glass-panel" style={{ padding: '2rem', textAlign: 'left', transition: 'transform 0.3s' }}>
            ...
            <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem', fontWeight: '600', color: 'var(--text-main)' }}>{feature.title}</h3>
